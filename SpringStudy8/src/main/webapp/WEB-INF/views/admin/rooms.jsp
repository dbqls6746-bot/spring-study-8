...
<body>
	...
	<div>
		<form action="" method="get">
			<h2>검색기준</h2>
			<label>건물/동 이름 <input type="checkbox" name="buildingName" value="searchId" <c:if test="${roomSearchCondition.buildingName != null}">checked</c:if>></label>
			<br>
	...
	<div>
		<button id = "btn_registerRoom">객실추가하기</button>
	</div>
